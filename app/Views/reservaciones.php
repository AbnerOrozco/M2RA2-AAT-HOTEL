...
<head>
    ...
    <title>Vistas reservaciones</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <div class="container">
    <h1>Reservaciones</h1>
    <a href='nuevo_reservacion' class="btn btn-primary mb-3">Nueva reservacion</a>
    ...
    <table class="table table-border table-striped">
        ...
        <tbody id="reservaciones">
            ...
            <tr>
                ...
                <td>
                    <a href="editar_reservaciones/<?php echo $Reservaciones['reservacion_id']; ?>" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    <a href="eliminar_reservacion/<?php echo $Reservaciones['reservacion_id']; ?>" class="btn btn-danger"><i class="bi bi-trash"></i>       </a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
...
<script>
    document.getElementById('searchInput').addEventListener('keyup', function() {
        ...
        var rows = document.querySelectorAll('#reservaciones tr');
